        ...
        <div style={{
          ...
          {user ? (
            <div ref={userMenuRef} style={{ position: "relative" }}>
              ...
              >
                {user.avatar ? (
                  <img src={user.avatar} alt="avatar" style={{ width: 36, height: 36, borderRadius: 9999, objectFit: "cover", boxShadow: "0 0 0 2px rgba(20,66,45,0.15)" }} />
                ) : (
              ...
              {dropdownOpen && (
                <div style={{ position: "absolute", top: "calc(100% + 10px)", right: 0, background: "white", borderRadius: 12, boxShadow: "0 8px 24px rgba(0,0,0,0.12)", overflow: "hidden", minWidth: 160, zIndex: 100 }}>
                  <Link
                    href="/profile"
