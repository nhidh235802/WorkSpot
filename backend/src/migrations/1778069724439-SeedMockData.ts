...
export class SeedMockData1778069724439 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        -- 30 Khách hàng
        ('${customers[0]}',  'Đinh Tùng Lâm',    'lam.dinh@gmail.com',     '0911111111', '${hash}', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400', 'Thanh Xuân, Hà Nội',  'Sinh viên IT chạy deadline.',    'customer', '${dC1}'),
        ('${customers[1]}',  'Hồ Thu Hương',     'huong.ho@gmail.com',     '0912222222', '${hash}', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400', 'Tây Hồ, Hà Nội',     'Freelancer Designer.',           'customer', '${dC2}'),
        ('${customers[2]}',  'Ngô Văn Nam',      'nam.ngo@gmail.com',      '0913333333', '${hash}', 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=400', 'Nam Từ Liêm, Hà Nội','NV Văn phòng.',                  'customer', '${dC3}'),
        ('${customers[3]}',  'Bùi Thị Lan',      'lan.bui@gmail.com',      '0914444444', '${hash}', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400', 'Hà Đông, Hà Nội',    'Đam mê review check-in.',        'customer', '${dC4}'),
        ('${customers[4]}',  'Đỗ Quang Huy',     'huy.do@gmail.com',       '0915555555', '${hash}', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400', 'Hoàng Mai, Hà Nội',  'Remote Worker.',                 'customer', '${dC5}'),
        ('${customers[5]}',  'Trần Minh Khải',   'khai.tran@gmail.com',    '0916111111', '${hash}', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400', 'Ba Đình, Hà Nội',    'Kỹ sư phần mềm thích cà phê.',   'customer', '${dC6}'),
        ('${customers[6]}',  'Lê Thanh Nga',     'nga.le@gmail.com',       '0916222222', '${hash}', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400', 'Cầu Giấy, Hà Nội',   'Sinh viên Ngoại thương.',        'customer', '${dC7}'),
        ('${customers[7]}',  'Phạm Tuấn Kiệt',  'kiet.pham@gmail.com',    '0916333333', '${hash}', 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400', 'Đống Đa, Hà Nội',    'Nhà văn tự do.',                 'customer', '${dC8}'),
        ('${customers[8]}',  'Nguyễn Hải Yến',  'yen.nguyen@gmail.com',   '0916444444', '${hash}', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400', 'Hai Bà Trưng, Hà Nội','Blogger ẩm thực.',               'customer', '${dC9}'),
        ('${customers[9]}',  'Vũ Thanh Long',    'long.vu@gmail.com',      '0916555555', '${hash}', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400', 'Hoàn Kiếm, Hà Nội',  'Startup founder.',               'customer', '${dC10}'),
        ('${customers[10]}', 'Mai Phương Thảo',  'thao.mai@gmail.com',     '0917111111', '${hash}', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400', 'Long Biên, Hà Nội',  'Content creator.',               'customer', '${dC11}'),
        ('${customers[11]}', 'Hoàng Anh Dũng',   'dung.hoang@gmail.com',   '0917222222', '${hash}', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400', 'Tây Hồ, Hà Nội',     'Product Manager.',               'customer', '${dC12}'),
        ('${customers[12]}', 'Đỗ Lan Anh',       'anh.do@gmail.com',       '0917333333', '${hash}', 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=400', 'Thanh Xuân, Hà Nội', 'UX Designer.',                   'customer', '${dC13}'),
        ('${customers[13]}', 'Ngô Gia Bảo',      'bao.ngo@gmail.com',      '0917444444', '${hash}', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400', 'Hà Đông, Hà Nội',    'Digital marketer.',              'customer', '${dC14}'),
        ('${customers[14]}', 'Lý Thị Diễm',      'diem.ly@gmail.com',      '0917555555', '${hash}', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400', 'Cầu Giấy, Hà Nội',   'Dịch thuật tự do.',              'customer', '${dC15}'),
        ('${customers[15]}', 'Phan Quốc Việt',   'viet.phan@gmail.com',    '0918111111', '${hash}', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400', 'Hoàng Mai, Hà Nội',  'Kế toán viên.',                  'customer', '${dC16}'),
        ('${customers[16]}', 'Dương Thị Hoa',    'hoa.duong@gmail.com',    '0918222222', '${hash}', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400', 'Nam Từ Liêm, Hà Nội', 'Giáo viên tiếng Anh.',          'customer', '${dC17}'),
        ('${customers[17]}', 'Bùi Trung Hiếu',   'hieu.bui@gmail.com',     '0918333333', '${hash}', 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400', 'Ba Đình, Hà Nội',    'Kiến trúc sư.',                  'customer', '${dC18}'),
        ('${customers[18]}', 'Trịnh Khánh Ly',   'ly.trinh@gmail.com',     '0918444444', '${hash}', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400', 'Đống Đa, Hà Nội',    'Nhân viên ngân hàng.',           'customer', '${dC19}'),
        ('${customers[19]}', 'Lê Văn Phúc',      'phuc.le@gmail.com',      '0918555555', '${hash}', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400', 'Hoàn Kiếm, Hà Nội',  'Nhiếp ảnh gia freelance.',       'customer', '${dC20}'),
        ('${customers[20]}', 'Nguyễn Thu Trang',  'trang.nguyen@gmail.com', '0919111111', '${hash}', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400', 'Tây Hồ, Hà Nội',    'Luật sư.',                       'customer', '${dC21}'),
        ('${customers[21]}', 'Võ Thành Trung',    'trung.vo@gmail.com',     '0919222222', '${hash}', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400', 'Hai Bà Trưng, Hà Nội','Bác sĩ nội trú.',               'customer', '${dC22}'),
        ('${customers[22]}', 'Hà Thị Nhung',     'nhung.ha@gmail.com',     '0919333333', '${hash}', 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=400', 'Cầu Giấy, Hà Nội',   'Dược sĩ.',                       'customer', '${dC23}'),
        ('${customers[23]}', 'Đinh Huy Hoàng',   'hoang.dinh@gmail.com',   '0919444444', '${hash}', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400', 'Long Biên, Hà Nội',  'Game developer.',                'customer', '${dC24}'),
        ('${customers[24]}', 'Phùng Minh Anh',   'anh.phung@gmail.com',    '0919555555', '${hash}', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400', 'Thanh Xuân, Hà Nội', 'Data analyst.',                  'customer', '${dC25}'),
        ('${customers[25]}', 'Cao Thị Thùy',     'thuy.cao@gmail.com',     '0920111111', '${hash}', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400', 'Hà Đông, Hà Nội',    'Copywriter.',                    'customer', '${dC26}'),
        ('${customers[26]}', 'Lưu Văn Đại',      'dai.luu@gmail.com',      '0920222222', '${hash}', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400', 'Ba Đình, Hà Nội',     'Kỹ sư điện.',                    'customer', '${dC27}'),
        ('${customers[27]}', 'Tô Thị Bình',      'binh.to@gmail.com',      '0920333333', '${hash}', 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400', 'Nam Từ Liêm, Hà Nội','Tư vấn tài chính.',             'customer', '${dC28}'),
        ('${customers[28]}', 'Chu Đình Toàn',    'toan.chu@gmail.com',     '0920444444', '${hash}', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400', 'Hoàng Mai, Hà Nội',  'QA Engineer.',                   'customer', '${dC29}'),
        ('${customers[29]}', 'Doãn Hà Linh',     'linh.doan@gmail.com',    '0920555555', '${hash}', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400', 'Đống Đa, Hà Nội',    'HR Manager.',                    'customer', '${dC30}');
    `);
